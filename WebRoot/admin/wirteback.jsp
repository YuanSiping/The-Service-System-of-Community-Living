...
<html>
  ...
  <body bgcolor="#E0EEEE">
  	<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
	    <TR height=28>
	    <TD background=admin/images/title_bg1.jpg>当前位置:回复居民留言</TD>
	    </TR>
	    <TR>
    ...
    <form action="ask.do?p=replyto&askid=${ask.asId }&time=${ask.asTime}&userid=${ask.user.UId }&text=${ask.asText }<" method="post" >
    	<table class="hovertable" style="BORDER-COLLAPSE: collapse;text-align: center;" border="0" cellspacing="0" cellpadding="1" align="center">
    		<tr>
    			...
    			<td bgcolor=#ADD8E6 align="left"><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${ask.asTime}"/></td>
    		</tr>
    		
    		<tr>
    			<td bgcolor=#ADD8E6>咨&nbsp;询&nbsp;者:</td>
    			<td bgcolor=#ADD8E6 align="left"><font >${ask.user.UName }</font></td>
    		</tr>
    		
    		<tr>
    			<td bgcolor=#ADD8E6 valign="top">咨询内容:</td>
    			<!--<td><textarea name="content" rows="12" cols="90"></textarea></td>  -->
    			<td bgcolor=#ADD8E6 align="left" width=80><font >${ask.asText }</font></td>
    		</tr>
    		
    		<tr>
    			<td valign="top"><font style="font-weight:bold">请&nbsp;回&nbsp;复：</font></td>
    			<td ><textarea name="replytext" rows="5" cols="90" ></textarea></td>
    		</tr>
